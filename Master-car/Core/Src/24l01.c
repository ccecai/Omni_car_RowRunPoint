...
uint8_t TX_ADDRESS[TX_ADR_WIDTH]={0x25,0x04,0x15,0x52,0x93}; //发送地址
uint8_t RX_ADDRESS[RX_ADR_WIDTH]={0x25,0x04,0x15,0x52,0x93}; //发送地址
...
void NRF24L01_RX_Mode(void)
{
    ...
    NRF24L01_Write_Reg(NRF_WRITE_REG + RF_CH, 23);       //设置RF通信频率
